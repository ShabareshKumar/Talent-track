...
- Should see 6 other users:
  ...
  2. Shabaresh Kumar (athlete_ae77e2c700a36856)
  3. Shabaresh (sai_admin_b97c85134da63daf)
  4. Shabaresh (athlete_60065cba8d150a6f)
  5. Shabaresh (athlete_0da07afede2d5c61)
  6. Shabaresh (athlete_8357cf9736124482)

### For Athlete (Shabaresh Kumar):
- Should see 6 other users (all except yourself)

### For SAI Admin (Shabaresh):
- Should see 6 other users (all except yourself)
